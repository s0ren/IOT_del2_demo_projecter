...
#define WAKEUP_GPIO              GPIO_NUM_34 // :-D    // Only RTC IO are allowed - ESP32 Pin example
...
// Define bitmask for all button GPIOs
uint64_t bitmask = BUTTON_PIN_BITMASK(WAKEUP_GPIO_34 | BUTTON_PIN_BITMASK(WAKEUP_GPIO_35) | BUTTON_PIN_BITMASK(WAKEUP_GPIO_32) | BUTTON_PIN_BITMASK(WAKEUP_GPIO_33));
...
fra https://randomnerdtutorials.com/esp32-external-wake-up-deep-sleep/
*/
